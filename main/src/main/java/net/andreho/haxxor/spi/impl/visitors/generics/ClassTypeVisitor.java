...
import net.andreho.haxxor.api.HxParameterizedType;
import net.andreho.haxxor.api.HxType;
import net.andreho.haxxor.api.HxTypeVariable;
import net.andreho.haxxor.api.impl.HxGenericArrayTypeImpl;
import net.andreho.haxxor.api.impl.HxParameterizedTypeImpl;
import net.andreho.haxxor.api.impl.HxWildcardTypeImpl;
...
public class ClassTypeVisitor extends ConsumingVisitor {
   ...
   */
  public ClassTypeVisitor(final Hx haxxor,
  ...
  public void visitTypeVariable(final String name) {
    ...
    HxGenericElement<?> result = typeVariable(name);
    while(dimension-- > 0) {
