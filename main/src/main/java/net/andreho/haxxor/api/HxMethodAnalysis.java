 ...
 */
public interface HxMethodAnalysis<O extends HxMethodOwner<O>>
  extends HxMethodOwner<O> {
   ...
   * @return a collection with methods with the given name
   */
   ...
   * @return
   */
  default List<HxMethod> methods(Predicate<HxMethod> predicate, boolean recursive) {
    return Collections.emptyList();
  }
   ...
   * @return
   */
  default List<HxMethod> constructors(Predicate<HxMethod> predicate, boolean recursive) {
    return Collections.emptyList();
  }
   ...
   */
  default Optional<HxMethod> findMethodDirectly(String name, String descriptor) {
    return Optional.empty();
  }
   ...
   * @return
   */
  default Optional<HxMethod> findOrCreateMethod(String returnType, String name, String ... parameters) {
   ...
   * @return
   */
  default Optional<HxMethod> findOrCreateMethod(Class<?> returnType, String name, Class<?> ... parameters) {
    return findOrCreateMethod(getHaxxor().reference(returnType), name, getHaxxor().references(parameters));
  }
   ...
   * @return
   */
  default Optional<HxMethod> findOrCreateMethod(HxType returnType, String name, HxType ... parameters) {
   ...
   * @return
   */
  default Optional<HxMethod> findOrCreateMethod(HxType returnType, String name, List<HxType> parameters) {
