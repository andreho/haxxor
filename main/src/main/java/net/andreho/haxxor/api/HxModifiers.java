...
public enum HxModifiers
  ...
  SUPER(0x0020), //redundant to SYNCHRONIZED
  SYNCHRONIZED(0x0020), //redundant to SUPER

  VOLATILE(0x0040), //redundant to BRIDGE
  BRIDGE(0x0040), //redundant to VOLATILE

  VARARGS(0x0080), //redundant to TRANSIENT
  TRANSIENT(0x0080), //redundant to VARARGS
