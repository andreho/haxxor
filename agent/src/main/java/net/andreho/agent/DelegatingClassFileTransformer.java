 ...
 */
final class DelegatingClassFileTransformer implements ClassFileTransformer {
   ...
   public byte[] transform(final ClassLoader loader,
      ...
      for (ClassFileTransformer transformer : transformers) {
         try {
            ...
            LOG.severe("Failed to apply transformation with: " + transformer.getClass().getName() + ", because of: " +
                       t.getMessage());
            return null;
         }
      }
