...
import net.andreho.haxxor.spi.impl.visitors.generics.ClassBoundVisitor;
import net.andreho.haxxor.spi.impl.visitors.generics.ControlledVisitor;
import net.andreho.haxxor.spi.impl.visitors.generics.InterfaceBoundVisitor;
import net.andreho.haxxor.spi.impl.visitors.generics.InterfaceVisitor;
import net.andreho.haxxor.spi.impl.visitors.generics.SuperclassVisitor;
