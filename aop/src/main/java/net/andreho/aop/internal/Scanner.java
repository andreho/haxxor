...
public class Scanner {
   ...
   * @throws IOException
   */
  public void scan(final ScannerVisitor visitor)
  throws IOException {
    final Enumeration<URL> resources = this.classLoader.getResources("");
  ...
  protected void scanFile(final URL rootUrl,
                          final File file,
                          final ScannerVisitor visitor)
  throws IOException {
    if (file.exists()) {
  ...
  protected void visitFile(final URL rootUrl,
                           final File file,
                           final ScannerVisitor visitor,
                           boolean isJar)
  throws IOException {
  ...
  protected void visitJar(final URL rootUrl,
                          final File file,
                          final ScannerVisitor visitor)
  throws IOException {
   ...
   * @return
   */
  public static String extractFilename(URL rootUrl,
                                       String name) {
